...
MyOptions options; // Deklarasi asli agar variabel tercipta

static int enable_hack;
static char *game_data_dir = nullptr;
static char *game_package_name = "com.dois.greedgame";
...
void drawMenu() {
    ImGui::Begin("KradGame Mod");
    ImGui::Checkbox("Unlimited Jump", &options.unlimited_jump); // Tambahkan ini
    ImGui::Checkbox("ESP Box", &options.esp_box);
    ImGui::ColorEdit4("Warna ESP", (float*)&options.esp_color);
    ImGui::End();
}
